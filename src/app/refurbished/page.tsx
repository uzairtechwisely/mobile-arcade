...
const popularRefurb = [
  { title: "Refurbished iPhone", subtitle: "Popular models and conditions" },
  { title: "Refurbished Samsung", subtitle: "Reliable Android options" },
  { title: "Budget refurbished", subtitle: "Great value everyday devices" },
] as const;
        ...
        <Container className="py-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-base leading-7 text-muted sm:text-lg">
              Browse refurbished devices on our online shop. If you want help choosing,
              use the store finder to speak to your nearest branch.
            </p>
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                href="/service-finder?service=refurbished&mode=in_shop"
        ...
        <Container className="py-12">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-base leading-7 text-muted">
              Start here, then open the online shop to browse current listings.
            </p>
          </div>
          <div className="mt-7 grid gap-4 sm:grid-cols-3">
            {popularRefurb.map((item) => (
              <a
                key={item.title}
                href={ECOMMERCE_URL}
                target="_blank"
